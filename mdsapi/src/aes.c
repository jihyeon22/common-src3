...
#define Nk_AES256 8
#define KEYLEN_AES256 32
#define Nr_AES256 14
#define keyExpSize_AES256 240

#define Nk_AES192 6
#define KEYLEN_AES192 24
#define Nr_AES192 12
#define keyExpSize_AES192 208

#define Nk_AES128 4      // The number of 32 bit words in a key.
#define KEYLEN_AES128 16 // Key length in bytes
#define Nr_AES128 10     // The number of rounds in AES Cipher.
#define keyExpSize_AES128 176


int AES_type = AES_TYPE_AES128;
int Nk = Nk_AES128;
int KEYLEN = KEYLEN_AES128;
int Nr = Nr_AES128;
int keyExpSize = keyExpSize_AES128;
...
// MDS_MODIFIED : set aes type

int mds_api_AES_init(int type)
{
    switch (type)
    {
        case AES_TYPE_AES128:
        {
            AES_type = AES_TYPE_AES128;
            Nk = Nk_AES128;
            KEYLEN = KEYLEN_AES128;
            Nr = Nr_AES128;
            keyExpSize = keyExpSize_AES128;
            break;
        }
        case AES_TYPE_AES192:
        {
            AES_type = AES_TYPE_AES192;
            Nk = Nk_AES192;
            KEYLEN = KEYLEN_AES192;
            Nr = Nr_AES192;
            keyExpSize = keyExpSize_AES192;
            break;
        }
        case AES_TYPE_AES256:
        {
            AES_type = AES_TYPE_AES256;
            Nk = Nk_AES256;
            KEYLEN = KEYLEN_AES256;
            Nr = Nr_AES256;
            keyExpSize = keyExpSize_AES256;
            break;
        }
        default:
        {
...
// MDS_MODIFIED : max size define...
static unsigned char RoundKey[keyExpSize_AES256];
